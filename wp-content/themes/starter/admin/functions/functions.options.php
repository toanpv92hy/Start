...
$of_options[] = array( 	"name" 		=> "Logo, Banner, Footer",
        ...
        $of_options[] = array(  "name"      => "Upload ảnh banner",
                        "type"      => "media",
                        "id"        => "banner_url"
                );
        ...
        $of_options[] = array( 	"name" 		=> "Địa chỉ Email gần Footer",
            ...
            "id" 		=> "footer_email",
            "std" 		=> "example@gmail.com",
            "type" 		=> "text"
        );

        $of_options[] = array( 	"name" 		=> "Điền thông tin footer",
            "desc" 		=> "Thông tin hiển thị ở cuối trang.",
            "id" 		=> "footer_text",
            "std" 		=> "&lt;p&gt;Copyright @ 2015&lt;/p&gt;",
            "type" 		=> "textarea"
        );
...
$of_options[] = array( 	"name" 		=> "Thông Tin Liên hệ",
    "type" 		=> "heading"
        ...
        //     "type"         => "text"
        // );
        $of_options[] = array(  "name"         => "Email liên hệ",
            "desc"         => "Email",
            "id"         => "contact_email",
            "std"         => "",
            "type"         => "text"
...
$of_options[] = array( 	"name" 		=> "Seo",
    "type" 		=> "heading"
        ...
        $of_options[] = array(     "name"         => "Favicon",
            "desc"         => "Upload ảnh Favicon hiển thị trên title (ảnh đuôi .ico).",
            "id"         => "favicon",
